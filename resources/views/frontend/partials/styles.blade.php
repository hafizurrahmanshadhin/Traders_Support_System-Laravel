@php
    $systemSettins = App\Models\SystemSetting::first();
@endphp
...
<link rel="shortcut icon" type="image/x-icon" href="{{ $systemSettins->favicon ?? 'frontend/images/logo.svg' }}">
...
{{-- Add dropdown menu list in header section --}}
<style>
    ...
    /* Dropdown menu scoped styles */
    .profile-dropdown .dropdown-menu {
        width: 250px;
    }

    .profile-dropdown .author-info {
        display: flex;
        align-items: center;
        padding: 10px;
    }

    .profile-dropdown .author-info .image img {
        border-radius: 50%;
        width: 50px;
        height: 50px;
        object-fit: cover;
    ...
    .profile-dropdown .author-info .content {
        margin-left: 10px;
    }

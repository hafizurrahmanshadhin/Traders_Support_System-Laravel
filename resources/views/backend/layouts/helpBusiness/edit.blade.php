                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Help Business</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('help.business.update', ['id' => $helpBusiness->id]) }}"
                        ...
                        <div class="input-style-1">
                            ...
                            <select id="type" name="type" class="form-control @error('type') is-invalid @enderror">
                                ...
                                <option value="pro" {{ old('type', $helpBusiness->type) == 'pro' ? 'selected' : '' }}>Pro
                                </option>
                                <option value="trade" {{ old('type', $helpBusiness->type) == 'trade' ? 'selected' : '' }}>
                                    Trade</option>
                            </select>
                            @error('type')
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Enter Title" id="title"
                                ...
                                value="{{ old('title', $helpBusiness->title) }}" />
                            @error('title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                id="image" data-default-file="{{ asset($helpBusiness->image) }}">
                            @error('image')
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea placeholder="Type here..." id="description" name="description"
                                ...
                                {{ old('description', $helpBusiness->description) }}
                            </textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('help.business.index') }}" class="btn btn-danger me-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

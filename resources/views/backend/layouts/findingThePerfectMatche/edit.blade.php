        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <form method="POST"
                        action="{{ route('partner.match.update', ['id' => $findingThePerfectMatche->id]) }}"
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Enter Title" id="title"
                                ...
                                value="{{ old('title', $findingThePerfectMatche->title) }}" />
                            @error('title')
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                id="image" data-default-file="{{ asset($findingThePerfectMatche->image) }}">
                            @error('image')

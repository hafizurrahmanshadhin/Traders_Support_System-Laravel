            ...
            <div class="col-lg-12">
                <div class="card-style mb-30">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('partner.match.create') }}" class="btn btn-primary">Add New Partner</a>
                    </div>
...
@push('script')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('partner.match.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('partner.match.destroy', ':id') }}';

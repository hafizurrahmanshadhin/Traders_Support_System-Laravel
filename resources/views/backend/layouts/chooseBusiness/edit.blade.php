                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Choose Business</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('choose.business.update', ['id' => $chooseBusiness->id]) }}"
                        ...
                        <div class="input-style-1">
                            ...
                            <select id="type" name="type" class="form-control @error('type') is-invalid @enderror">
                                ...
                                <option value="pro" {{ old('type', $chooseBusiness->type) == 'pro' ? 'selected' : '' }}>
                                    Pro
                                </option>
                                <option value="trade"
                                    {{ old('type', $chooseBusiness->type) == 'trade' ? 'selected' : '' }}>
                                    Trade</option>
                            </select>
                            @error('type')
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Enter Title" id="title"
                                ...
                                value="{{ old('title', $chooseBusiness->title) }}" />
                            @error('title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                id="image" data-default-file="{{ asset($chooseBusiness->image) }}">
                            @error('image')
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea placeholder="Type here..." id="description" name="description"
                                ...
                                {{ old('description', $chooseBusiness->description) }}
                            </textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('choose.business.index') }}" class="btn btn-danger me-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('choose.business.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="input-style-1">
                            <label for="type">Type:</label>
                            <select id="type" name="type" class="form-control @error('type') is-invalid @enderror">
                                <option value="">Select Type</option>
                                <option value="pro" {{ old('type') == 'pro' ? 'selected' : '' }}>Pro</option>
                                <option value="trade" {{ old('type') == 'trade' ? 'selected' : '' }}>Trade</option>
                            </select>
                            @error('type')
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" placeholder="Type here..." id="description"

            ...
            <div class="col-lg-12">
                <div class="card-style mb-30">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('choose.business.create') }}" class="btn btn-primary">Add New Business</a>
                    </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('choose.business.index') }}",
                        type: "get",
                    },
        ...
        function statusChange(id) {
            let url = '{{ route('choose.business.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('choose.business.destroy', ':id') }}';

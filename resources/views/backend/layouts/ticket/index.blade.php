                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Ticket</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
@push('script')
    <script>
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'random_ticket_id',
                            name: 'random_ticket_id',
                            orderable: true,
                            searchable: true
                        },
                        {
        ...
        function statusChange(id) {
            let url = '{{ route('admin.ticket.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function updateStatus(id, status) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Check the status and update the icon accordingly
                    ...
                    // Show a notification using Toastr.js with custom options

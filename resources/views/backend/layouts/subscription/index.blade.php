                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Pro Subscription</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card-style mb-30">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('admin.subscription.create') }}" class="btn btn-primary">Add New Subscription</a>
                    </div>
...
@push('script')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('admin.subscription.status', ':id') }}';
            $.ajax({
                type: "GET",

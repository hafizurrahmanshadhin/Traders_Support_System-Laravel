...
@section('title', 'Create Pro Subscription')
                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Create Pro
                                Subscription</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.subscription.store') }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <select id="user_type" name="user_type"
                                        ...
                                        <option value="pro" {{ old('user_type') == 'pro' ? 'selected' : '' }}>Pro
                                        </option>
                                        <option value="trade" {{ old('user_type') == 'trade' ? 'selected' : '' }}>Trade
                                        </option>
                                    </select>
                                    @error('user_type')
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" placeholder="Enter Package Duration" id="package_duration"
                                        ...
                                        name="package_duration" value="{{ old('package_duration') }}" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <input type="number" placeholder="Enter View Limit" id="view_limit"
                                        class="form-control @error('view_limit') is-invalid @enderror" name="view_limit"
                                        value="{{ old('view_limit') }}" />
                                    @error('view_limit')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <input type="number" placeholder="Enter Message Limit" id="message_limit"
                                        class="form-control @error('message_limit') is-invalid @enderror"
                                        name="message_limit" value="{{ old('message_limit') }}" />
                                    @error('message_limit')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="input-style-1">
                            ...
                            <select id="timeline" name="timeline"
                                ...
                                <option value="">Select Type</option>
                                <option value="Monthly" {{ old('timeline') == 'Monthly' ? 'selected' : '' }}>Monthly
                                </option>
                                <option value="Yaerly" {{ old('timeline') == 'Yearly' ? 'selected' : '' }}>Yearly</option>
                            </select>
                            @error('timeline')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
    ...
    <script>
        function updatePackageTypeOptions() {
            ...
            if (userType === 'pro') {
                ...
                packageTypeSelect.innerHTML +=
                    '<option value="elite" {{ old('package_type') == 'elite' ? 'selected' : '' }}>Elite</option>';
            } else if (userType === 'trade') {
                packageTypeSelect.innerHTML +=
                    '<option value="popular" {{ old('package_type') == 'popular' ? 'selected' : '' }}>Popular</option>';
                packageTypeSelect.innerHTML +=

...
return [
    ...
    */
    ...
    |-------------------------------------
    */
    'storage_disk_name' => env('CHATIFY_STORAGE_DISK', 'chatify_uploads'),
    ...
    */
    ...
    'api_routes' => [
        ...
        'namespace' => env('CHATIFY_API_ROUTES_NAMESPACE', 'Http\Controllers\vendor\Chatify\Api'),
    ],
    ...
    */
    'user_avatar' => [
        'folder' => '',
        'default' => "{{asset('uploads/users/jobaed-bhuiyan-1723955257.png')}}",
    ],
